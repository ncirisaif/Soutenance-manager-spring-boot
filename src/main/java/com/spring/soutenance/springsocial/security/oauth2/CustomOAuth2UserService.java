...
import com.spring.soutenance.springsocial.security.oauth2.user.OAuth2UserInfo;
import com.spring.soutenance.springsocial.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<UserApp> userOptional = userRepository.findByEmail(oAuth2UserInfo.getEmail());
        UserApp user;
